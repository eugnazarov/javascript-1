...
function handleClick(clickedButtonEvent) {
    ...
    const card = {
        wrap: cardNode.querySelector('div'), // здесь элемент с классом .product
...
function hideMoreText(card) {
    ...
    let desc = document.querySelector(".desc").remove();
...
function showMoreText(card) {
    ...
    let text = "Lorem ipsum dolor sit amet, consectetur adipisicing elit. A commodi consequuntur doloribus laborum odit rem!"
